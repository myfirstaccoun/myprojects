...
function changetxtsize () {
    if (parseFloat(inpt.innerText) < 10000000) {
        inpt.style.fontSize = "60px";
        inpt.style.top = "0";
    } else if (parseFloat(inpt.innerText) >= 10000000 && parseFloat(inpt.innerText) < 100000000) {
        inpt.style = "font-size: 55px; top: 10px";
    } else if (parseFloat(inpt.innerText) >= 100000000 && parseFloat(inpt.innerText) < 1000000000) {
        inpt.style.fontSize = "50px";
    } else if (parseFloat(inpt.innerText) >= 1000000000 && parseFloat(inpt.innerText) < 10000000000) {
        inpt.style.fontSize = "45px";
        inpt.style.top = "15px";
    } else if (parseFloat(inpt.innerText) >= 10000000000 && parseFloat(inpt.innerText) < 100000000000) {
        inpt.style.fontSize = "40px";
        inpt.style.top = "25px";
    } else if (parseFloat(inpt.innerText) >= 100000000000 && parseFloat(inpt.innerText) < 1000000000000) {
        inpt.style.fontSize = "38px";
        inpt.style.top = "30px";
    } else if (parseFloat(inpt.innerText) >= 1000000000000) {
